...
export const routes: Routes = [
  ...
  },
  {
    path: 'meters',
    loadComponent: () =>
      import('./features/meters/meter-list/meter-list').then((m) => m.MeterList),
    title: 'Meters - Meter Tracker',
  },
  {
    path: 'meters/new',
    loadComponent: () =>
      import('./features/meters/meter-form/meter-form').then((m) => m.MeterForm),
    title: 'New meter - Meter Tracker',
  },
  {
    path: 'meters/:id',
    loadComponent: () =>
      import('./features/meters/meter-detail/meter-detail').then(
        (m) => m.MeterDetail,
      ),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/readings/reading-form/reading-form').then(
        (m) => m.ReadingForm,
      ),
