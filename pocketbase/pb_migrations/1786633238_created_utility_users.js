...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_1169277387",
    "indexes": [
      "CREATE UNIQUE INDEX `idx_tokenKey_pbc_1169277387` ON `utility_users` (`tokenKey`)",
      "CREATE UNIQUE INDEX `idx_email_pbc_1169277387` ON `utility_users` (`email`) WHERE `email` != ''"
    ],
    "listRule": null,
    "manageRule": null,
    "mfa": {
